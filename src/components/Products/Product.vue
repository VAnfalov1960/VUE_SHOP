        ...
        <v-flex xs12 lg6>
          <div class="product_info">
            ...
            <p class="product_category title">
              <span class="product_title">Продавец: </span>{{ product.vendor.charAt(0).toUpperCase() + product.vendor.substr(1) }}
            </p>
            <p class="product_price title">
              <span class="product_title">Цена: </span>{{ product.price }} руб.
            </p>
